...
//		}
		...
		while(isTrue) {
			...
			//
			System.out.println("\"Mono\" test passed: " + TestGraph.testMono(g));
			System.out.println("\"Direct\" test passed: " + TestGraph.testDirect(g));
			System.out.println("\"Chain\" test passed: " + TestGraph.testChain(g));
			...
			if (route == null) 
				...
				Collections.reverse(route.vertices);
				Iterator<Vertex> iter = route.vertices.iterator();
